...
export function IncidentChat({ isEnabled: enabledOverride }: { isEnabled?: boolean }) {
  ...
  return (
    <>
      ...
      <div ref={conversationRef} aria-live="polite" className={`chat-scroll mt-5 space-y-3 overflow-x-hidden overflow-y-auto pr-2 ${isExpanded ? "min-h-0 flex-1" : "max-h-96"}`}>
